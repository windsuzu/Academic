...
![](../../.gitbook/assets/find_hyperparameter_grid.png)

* **隨機選擇**測試組合
  * 這是相對不錯的測試方法

![](../../.gitbook/assets/find_hyperparameter_random.png)
...
* 在先前我們學過 [Normalize input](optimization.md)
...
![](../../.gitbook/assets/softmax_example.png)
